...
RSpec.describe Computer do
  ...
  it "should return -1 when it is lose" do
    ...
    expect(computer.alphabeta(board, Mark::ROUND, -1000, 1000)).to eq(-1)
  end
  ...
  it "should return 0 when it is a tie" do
    ...
    expect(computer.alphabeta(board, Mark::ROUND, -1000, 1000)).to eq(0)
  end
  ...
  it "should return 1 when computer will win in all solution" do
    ...
    expect(computer.alphabeta(board, Mark::CROSS, -1000, 1000)).to eq(1)
  end
